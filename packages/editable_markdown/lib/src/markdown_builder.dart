...
import 'package:editable_markdown/src/markdown_style_sheet.dart';
import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';
import 'package:markdown/markdown.dart' as md;

typedef ImageInsertion = void Function(String imageUrl);
...
class MarkdownBuilder implements md.NodeVisitor {
  ...
  MarkdownBuilder({
    ...
    required this.onImageInsertion,
  ...
  final ImageInsertion? onImageInsertion;
  ...
  /// Returns textspans that display the given Markdown nodes.
  ///
  /// The returned textspans are typically used as children of a [RichText]
  List<TextSpan> build(List<md.Node> nodes) {
    _listIndents.clear();
    _blocks.clear();
    _tables.clear();
    _inlines.clear();
